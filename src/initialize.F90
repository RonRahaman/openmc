  ...
  subroutine initialize_run()
      ...
      if (run_mode /= MODE_PLOTTING) then
        ...
        if (grid_method == GRID_UNION) then
          ...
          message = "Nuclide energy grid was specified, but energy banding requires unionized grid."
          call fatal_error()
        end if
...
!===============================================================================
! ALLOCATE_EBAND_BANK initializes the bounds for the energy bands, based on the
